                    ...
                    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block min-w-full py-2 mt-6 align-middle sm:px-6 lg:px-8">
                            ...
                            <div class="mt-4">
                                ...
                                <span class="flex justify-center w-full px-4 py-2 mx-auto text-center md:w-2/4">
                                    <a href="{{ route('integrations.index', ['report' => $report]) }}" class="flex justify-center w-full px-4 py-2 font-medium text-white transition duration-150 ease-in-out bg-yellow-600 border border-transparent rounded-md hover:bg-yellow-500 focus:outline-none focus:border-yellow-700 focus:ring-yellow active:bg-yellow-700">
                                        Volume d'intégration des flux
                                    </a>
                                </span>
                                <span class="flex justify-center w-full px-4 py-2 mx-auto text-center md:w-2/4">
                                    <a href="{{ route('pre-tfj.index', ['report' => $report]) }}" class="flex justify-center w-full px-4 py-2 font-medium text-white transition duration-150 ease-in-out bg-yellow-600 border border-transparent rounded-md hover:bg-yellow-500 focus:outline-none focus:border-yellow-700 focus:ring-yellow active:bg-yellow-700">
