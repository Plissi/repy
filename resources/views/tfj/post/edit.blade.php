...
@section('title', 'Travaux après TFJ')
    ...
    <div>
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <h2 class="mt-6 text-3xl font-extrabold leading-9 text-center text-gray-900">
                Travaux après TFJ du {{ date('d-m-Y', strtotime($report -> date)) }} de la <span class="uppercase">{{ $report -> bank -> name }}</span>
            </h2>
        </div>
                    ...
                    <div class="inline-block min-w-full py-2 align-middle">
                        <div class="py-8 max-w-md bg-white shadow sm:rounded-lg mt-8 sm:mx-auto sm:w-full lg:max-w-xl">
                            <div class="py-8 bg-white shadow sm:rounded-lg sm:px-10">
                                @livewire('tfj.post.edit', ['report' => $report])
                            </div>
                        </div>
                    </div>
                    </div>
